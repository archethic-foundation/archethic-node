defmodule Archethic.Contracts.Interpreter.Version1.Library.Common.ChainTest do
  @moduledoc """
  ...
  alias Archethic.Contracts.Interpreter.Version1.Library.Common.Chain
  ...
  # ----------------------------------------
  describe "fetch_genesis_address/1" do
    test "should work" do
      ...
      actions triggered_by: transaction do
        Contract.set_content Chain.fetch_genesis_address("#{Base.encode16(tx_address)}")
      end
      """
  ...
  # ----------------------------------------
  describe "fetch_first_transaction_address/1" do
    test "should work when there is a first transaction" do
      ...
      code = ~s"""
      actions triggered_by: transaction do
        Contract.set_content Chain.fetch_first_transaction_address("#{Base.encode16(tx_address)}")
      end
      """
  ...
  # ----------------------------------------
  describe "fetch_genesis_public_key/1" do
    test "should work" do
      ...
      code = ~s"""
      actions triggered_by: transaction do
        Contract.set_content Chain.fetch_genesis_public_key("#{Base.encode16(pub_key)}")
      end
      """
