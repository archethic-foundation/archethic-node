defmodule Archethic.SelfRepair.NotifierTest do
  ...
  describe "when a node is becoming offline new nodes should receive transaction to replicate" do
    ...
    test "sync_chain/1 Manual piping asserts", %{
      ...
      |> tap(fn x ->
        assert [
                 {<<0, 0, 173, 101, 18, 205, 43, 59, 180, 93, 83, 18, 213, 205, 199, 213, 145, 76,
                    251, 44, 60, 191, 122, 82, 118, 247, 170, 144, 49, 2, 31, 141, 191, 67>>,
                  [
                    <<1, 1, 4, 77, 145, 160, 161, 167, 207, 6, 162, 144, 45, 56, 66, 248, 45, 39,
                      145, 188, 191, 62, 230, 246, 220, 141, 224, 249, 14, 83, 233, 153, 28, 60,
                      179, 54, 132, 183, 185, 230, 111, 38, 231, 201, 245, 48, 47, 115, 198, 152,
                      151, 190, 95, 48, 29, 233, 166, 53, 33, 160, 138, 196, 239, 52, 193, 135,
                      40>>,
                    "node3",
                    "node2"
                  ]},
                 ...
                 {<<0, 0, 192, 250, 30, 251, 248, 152, 199, 106, 223, 237, 137, 176, 214, 135,
                    207, 197, 158, 98, 51, 235, 230, 141, 47, 130, 95, 158, 173, 46, 124, 92, 173,
                    199>>,
                  [
                    "node2",
                    "node3",
      ...
      |> Notifier.notify_nodes(genesis_address)
    end
