defmodule Uniris.ContractsTest do
  ...
  describe "accept_new_contract?/2" do
    test "should return false with different value and not inherit constraints defined" do
      code = """
    ...
    test "should return false when the inherit constraints return false" do
      code = """
      condition inherit,
