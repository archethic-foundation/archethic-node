defmodule Uniris.ElectionTest do
  ...
  describe "validation_nodes/1" do
    test "should change for new transaction" do
      ...
      first_election =
        Election.validation_nodes(tx1, authorized_nodes, ValidationConstraints.new())
    ...
    test "should select validation nodes according to the constraints provided" do
      authorized_nodes = [
        %Node{
          first_public_key: "Node0",
          last_public_key: "Node0",
