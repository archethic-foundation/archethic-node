defmodule UnirisValidation do
  ...
  """
  @spec start_validation(Transaction.pending(), binary(), list(binary())) :: {:ok, pid()}
  ...
  @spec add_context(
          tx_address :: binary(),
          validation_node_public_key :: binary(),
          previous_storage_node_public_keys :: list(binary()),
          validation_node_views :: list(),
          storage_node_views :: list()
        ) :: :ok
  def add_context(
        tx_address,
