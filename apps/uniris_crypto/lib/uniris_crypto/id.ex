defmodule UnirisCrypto.ID do
  ...
  """
  @spec id_from_curve(UnirisCrypto.supported_curve()) :: integer()
  ...
  """
  @spec curve_from_id(integer()) :: UnirisCrypto.supported_curve()
  ...
  """
  @spec id_from_hash(UnirisCrypto.supported_hash()) :: integer()
  ...
  @spec identify_keypair({binary(), binary()}, integer()) ::
          {UnirisCrypto.key(), UnirisCrypto.key()}
