defmodule UnirisCore.P2P.Node do
  ...
  @type t() :: %__MODULE__{
          first_public_key: UnirisCore.Crypto.key(),
          last_public_key: UnirisCore.Crypto.key(),
          ip: :inet.ip_address(),
  ...
  ## Examples
      ...
      iex> UnirisCore.P2P.Node.serialize(%UnirisCore.P2P.Node{
  ...
  ## Examples
      ...
      iex> UnirisCore.P2P.Node.deserialize(<<
  ...
  """
  @spec deserialize(bitstring()) :: {UnirisCore.P2P.Node.t(), bitstring}
  def deserialize(
