defmodule UnirisCore.Transaction.ValidationStamp do
  ...
  ## Examples
     ...
     iex> UnirisCore.Transaction.ValidationStamp.serialize(%UnirisCore.Transaction.ValidationStamp{
     ...
     ...>   ledger_operations: %UnirisCore.Transaction.ValidationStamp.LedgerOperations{ fee: 0.1, transaction_movements: [], node_movements: [], unspent_outputs: []},
  ...
  ## Examples
      ...
      ...> 238, 221, 14, 89, 120, 225, 39, 33, 95, 95, 225, 113, 143, 200, 47, 96, 239,
      ...> 66, 182, 168, 35, 129, 240, 35, 183, 47, 69, 154, 37, 172>>
      ...> |> UnirisCore.Transaction.ValidationStamp.deserialize()
      {
        %UnirisCore.Transaction.ValidationStamp{
          proof_of_work: <<0, 34, 248, 200, 166, 69, 102, 246, 46, 84, 7, 6, 84, 66, 27, 8, 78, 103, 37,
            155, 114, 208, 205, 40, 44, 6, 159, 178, 5, 186, 168, 237, 206,>>,
          proof_of_integrity: << 0, 49, 174, 251, 208, 41, 135, 147, 199, 114, 232, 140, 254, 103, 186, 138, 175,
            28, 156, 201, 30, 100, 75, 172, 95, 135, 167, 180, 242, 16, 74, 87, 170>>,
