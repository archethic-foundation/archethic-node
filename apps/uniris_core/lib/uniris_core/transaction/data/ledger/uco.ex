defmodule UnirisCore.TransactionData.UCOLedger do
  ...
  ## Examples
      ...
      iex> UnirisCore.TransactionData.UCOLedger.serialize(%UnirisCore.TransactionData.UCOLedger{transfers: [
      ...
      >>
  """
  @spec serialize(UnirisCore.TransactionData.UCOLedger.t()) :: binary()
  ...
  ## Examples
      ...
      ...> |> UnirisCore.TransactionData.UCOLedger.deserialize()
      {
        %UnirisCore.TransactionData.UCOLedger{
          transfers: [
            %UnirisCore.TransactionData.Ledger.Transfer{
              to: <<0, 59, 140, 2, 130, 52, 88, 206, 176, 29, 10, 173, 95, 179, 27, 166, 66, 52,
                    165, 11, 146, 194, 246, 89, 73, 85, 202, 120, 242, 136, 136, 63, 53>>,
      ...
      iex> UnirisCore.TransactionData.UCOLedger.deserialize(<<0, 156, 213, 216, 36, 138, 118, 198, 118, 250, 70, 24, 14, 67, 139, 145, 229,
