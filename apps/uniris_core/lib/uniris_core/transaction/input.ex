defmodule UnirisCore.TransactionInput do
  @moduledoc """
  ...
  ## Examples
      ...
      ...> }
      ...> |> UnirisCore.TransactionInput.serialize()
      ...> |> UnirisCore.TransactionInput.deserialize()
      {
        %UnirisCore.TransactionInput{
          from:  <<0, 53, 130, 31, 59, 131, 78, 78, 34, 179, 66, 2, 120, 117, 4, 119, 81, 111, 187,
            166, 83, 194, 42, 253, 99, 189, 24, 68, 40, 178, 142, 163, 56>>,
          amount: 10.5,
          spent?: true
