defmodule UnirisCore.ReleaseTasks.HostWebsiteUniris do
  ...
  defp assets_seeds() do
    %{
      ...
      Application.app_dir(:uniris_core, "priv/uniris.io/bootstrap.min.css") =>
        "bootstrap_css_seed",
      ...
      Application.app_dir(:uniris_core, "priv/uniris.io/magnific-popup.css") =>
        "magnificpopup_css_seed",
      Application.app_dir(:uniris_core, "priv/uniris.io/main.css") => "uniris_css_seed",
      Application.app_dir(:uniris_core, "priv/uniris.io/owl.carousel.min.css") =>
        "owlcarousel_css_seed",
      Application.app_dir(:uniris_core, "priv/uniris.io/owl.carousel.min.js") =>
        "owlcarousel_js_seed",
      ...
      Application.app_dir(:uniris_core, "priv/uniris.io/jquery.countdown.min.js") =>
        "jquerycountdown_seed",
      Application.app_dir(:uniris_core, "priv/uniris.io/jquery.magnificpopup.min.js") =>
      ...
      Application.app_dir(:uniris_core, "priv/uniris.io/d3_topo_json.min.js") =>
        "d3topojson_seed",
      Application.app_dir(:uniris_core, "priv/uniris.io/biometric_animation.js") =>
        "uniris_biometricanim_seed",
      Application.app_dir(:uniris_core, "priv/uniris.io/blockchain_animation.js") =>
        "uniris_blockchainanim_seed",
      Application.app_dir(:uniris_core, "priv/uniris.io/form_validator.min.js") =>
        "formvalidator_seed",
      Application.app_dir(:uniris_core, "priv/uniris.io/world-110m.json") => "world-110_seed",
      ...
      Application.app_dir(:uniris_core, "priv/uniris.io/UNIRIS-White-Paper.pdf") =>
        "uniris_whitepaper_seed",
      Application.app_dir(:uniris_core, "priv/uniris.io/UNIRIS-White-Paper-FR.pdf") =>
        "uniris_whitepaper_fr_seed",
      Application.app_dir(:uniris_core, "priv/uniris.io/UNIRIS-YellowPaper-Season1-Network.pdf") =>
        "uniris_yellowpaper_s1_seed",
      Application.app_dir(:uniris_core, "priv/uniris.io/UNIRIS-YellowPaper-Saison1-Reseau.pdf") =>
