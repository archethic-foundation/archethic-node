defmodule UnirisCore.P2P.MessageTest do
  ...
  describe "decode/1" do
    test "should deserialize a GetBootstrappingNodes message" do
    ...
    test "should deserialize a GetStorageNonce message" do
      {public_key, _} = Crypto.generate_deterministic_keypair("seed", :secp256r1)
    ...
    test "should deserialize a ListNodes message" do
      assert %ListNodes{} =
               %ListNodes{}
               |> Message.encode()
               |> Message.decode()
    ...
    test "should deserialize a GetTransaction message" do
    ...
    test "should deserialize a GetTransactionChain message" do
      address = <<0::8>> <> :crypto.strong_rand_bytes(32)
    ...
    test "should deserialize a GetUnspentOutputs message" do
      address = <<0::8>> <> :crypto.strong_rand_bytes(32)
    ...
    test "should deserialize a GetProofOfIntegrity message" do
      address = <<0::8>> <> :crypto.strong_rand_bytes(32)
    ...
    test "should deserialize a NewTransaction message" do
      tx = Transaction.new(:transfer, %TransactionData{}, "seed", 0)
    ...
    test "should deserialize a StartMining message" do
      tx = Transaction.new(:transfer, %TransactionData{}, "seed", 0)
      {welcome_node_public_key, _} = Crypto.generate_deterministic_keypair("wkey")
    ...
    test "should deserialize a GetTransactionHistory message" do
      address = <<0::8>> <> :crypto.strong_rand_bytes(32)
    ...
    test "should deserialize a AddContext message" do
      msg = %AddContext{
        address:
          <<0, 227, 129, 244, 35, 48, 113, 14, 75, 1, 127, 107, 32, 29, 93, 232, 119, 254, 1, 65,
            32, 47, 129, 164, 142, 240, 43, 22, 81, 188, 212, 56, 238>>,
    ...
    test "should deserialize a CrossValidate message" do
      msg = %CrossValidate{
        address:
          <<0, 227, 129, 244, 35, 48, 113, 14, 75, 1, 127, 107, 32, 29, 93, 232, 119, 254, 1, 65,
            32, 47, 129, 164, 142, 240, 43, 22, 81, 188, 212, 56, 238>>,
    ...
    test "should deserialize a CrossValidationDone message" do
      msg = %CrossValidationDone{
        address:
          <<0, 227, 129, 244, 35, 48, 113, 14, 75, 1, 127, 107, 32, 29, 93, 232, 119, 254, 1, 65,
            32, 47, 129, 164, 142, 240, 43, 22, 81, 188, 212, 56, 238>>,
    ...
    test "should deserialize a ReplicateTransaction message" do
      msg = %ReplicateTransaction{
        transaction: %Transaction{
          address:
            <<0, 46, 140, 65, 49, 7, 111, 10, 130, 53, 72, 25, 43, 47, 81, 130, 161, 225, 87, 144,
    ...
    test "should deserialize a AcknowledgeStorage message" do
      address = <<0::8>> <> :crypto.strong_rand_bytes(32)
    ...
    test "should deserialize a GetBeaconSlots message" do
      msg = %GetBeaconSlots{
        subsets_slots: %{
          <<1>> => [
    ...
    test "should deserialize a AddNodeInfo message" do
      msg = %AddNodeInfo{
        subset: <<0>>,
        node_info: %UnirisCore.BeaconSlot.NodeInfo{
          public_key:
    ...
    test "should deserialize a GetLastTransaction message" do
      address = <<0::8>> <> :crypto.strong_rand_bytes(32)
    ...
    test "should deserialize a GetBalance message" do
      address = <<0::8>> <> :crypto.strong_rand_bytes(32)
    ...
    test "should deserialize a GetTransactionInputs message" do
      address = <<0::8>> <> :crypto.strong_rand_bytes(32)
    ...
    test "should deserialize a Ok message" do
      assert %Ok{} == %Ok{} |> Message.encode() |> Message.decode()
    end

    test "should deserialize a NotFound message" do
      assert %NotFound{} == %NotFound{} |> Message.encode() |> Message.decode()
    end

    test "should deserialize a Transaction message" do
      tx = Transaction.new(:transfer, %TransactionData{}, "seed", 0)
    ...
    test "should deserialize a TransactionList message" do
      msg = %TransactionList{
        transactions: [
          %Transaction{
            address:
    ...
    test "should deserialize a UnspentOutputList message " do
      msg = %UnspentOutputList{
        unspent_outputs: [
          %UnspentOutput{
            from:
    ...
    test "should deserialize a NodeList message" do
      msg = %NodeList{
        nodes: [
          %Node{
            ip: {127, 0, 0, 1},
    ...
    test "should deserialize a BeaconSlotList message" do
      msg = %BeaconSlotList{
        slots: [
          %BeaconSlot{
            transactions: [
    ...
    test "should deserialize a TransactionHistory message" do
      msg = %TransactionHistory{
        transaction_chain: [
          %Transaction{
            address:
    ...
    test "should deserialize a Balance message" do
      assert %Balance{
               uco: 10.5
             } ==
               %Balance{
    ...
    test "should deserialize a EncryptedStorageNonce message" do
      msg = %EncryptedStorageNonce{
        digest:
          <<113, 15, 188, 151, 173, 16, 195, 140, 160, 244, 75, 59, 47, 220, 113, 96, 241, 34, 99,
            157, 115, 207, 195, 78, 32, 175, 171, 213, 154, 54, 113, 236>>
    ...
    test "should deserialize a ProofOfIntegrity message" do
      address = <<0::8>> <> :crypto.strong_rand_bytes(32)
    ...
    test "should deserialize a BootstrappingNodes message" do
      msg = %BootstrappingNodes{
        new_seeds: [
          %Node{
            ip: {127, 0, 0, 1},
