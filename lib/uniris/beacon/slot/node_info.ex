defmodule Uniris.BeaconSlot.NodeInfo do
  @moduledoc """
  ...
  ## Examples
        ...
        iex> Uniris.BeaconSlot.NodeInfo.serialize(%Uniris.BeaconSlot.NodeInfo{
  ...
  ## Examples
      ...
      iex> %Uniris.BeaconSlot.NodeInfo{
      ...>   public_key:  <<0, 27, 7, 231, 56, 158, 71, 37, 55, 178, 16, 94, 82, 36, 5, 33, 248, 1, 151, 236,
      ...>    81, 191, 35, 110, 247, 4, 87, 172, 199, 154, 209, 17, 94>>,
      ...>   timestamp: ~U[2020-06-25 15:11:53Z],
      ...>   ready?: true
      ...> }
      ...> |> Uniris.BeaconSlot.NodeInfo.serialize()
      ...> |> Uniris.BeaconSlot.NodeInfo.deserialize()
      {
        %Uniris.BeaconSlot.NodeInfo{
          public_key:  <<0, 27, 7, 231, 56, 158, 71, 37, 55, 178, 16, 94, 82, 36, 5, 33, 248, 1, 151, 236,
            81, 191, 35, 110, 247, 4, 87, 172, 199, 154, 209, 17, 94>>,
          timestamp: ~U[2020-06-25 15:11:53Z],
          ready?: true
