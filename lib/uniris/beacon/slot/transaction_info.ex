defmodule Uniris.BeaconSlot.TransactionInfo do
  @moduledoc """
  ...
  ## Examples
        ...
        iex> Uniris.BeaconSlot.TransactionInfo.serialize(%Uniris.BeaconSlot.TransactionInfo{
  ...
  ## Example
      ...
      iex> %Uniris.BeaconSlot.TransactionInfo{
      ...>   address:  <<0, 11, 4, 226, 118, 242, 59, 165, 128, 69, 40, 228, 121, 127, 37, 154, 199,
      ...>     168, 212, 53, 82, 220, 22, 56, 222, 223, 127, 16, 172, 142, 218, 41, 247>>,
      ...>   timestamp: ~U[2020-06-25 15:11:53Z],
      ...>   type: :transfer,
      ...
      ...>   ]
      ...> }
      ...> |> Uniris.BeaconSlot.TransactionInfo.serialize()
      ...> |> Uniris.BeaconSlot.TransactionInfo.deserialize()
      {
        %Uniris.BeaconSlot.TransactionInfo{
          address:  <<0, 11, 4, 226, 118, 242, 59, 165, 128, 69, 40, 228, 121, 127, 37, 154, 199,
              168, 212, 53, 82, 220, 22, 56, 222, 223, 127, 16, 172, 142, 218, 41, 247>>,
            timestamp: ~U[2020-06-25 15:11:53Z],
            type: :transfer,
