defmodule Uniris.Governance.Code.Proposal.Parser do
  @moduledoc false
  ...
  ## Examples
      ...
      ...> "
      ...> |> Parser.get_changes()
      {:ok, "diff --git a/lib/uniris/governance.ex b/lib/uniris/governance.ex
       index 30787f1..6535f52 100644
       --- a/lib/uniris/governance.ex
       +++ b/lib/uniris/governance.ex
       @@ -1,107 +1,107 @@" }
  ...
  ## Examples
      iex> "diff --git a/lib/uniris/supervisor.ex b/lib/uniris/supervisor.ex
      ...> index 124088f..c3add90 100755
      ...> --- a/lib/uniris/supervisor.ex"
      ...> |> Parser.list_files()
      ["lib/uniris/supervisor.ex"]
  """
