defmodule Uniris.Governance.Pools do
  @moduledoc """
  Governance pool management.

  The Uniris governance is spread across several pool of voters with different power or area of expertise.
  ...
  @type pool :: :foundation | :technical_council | :ethical_council | :uniris | :miners | :users
