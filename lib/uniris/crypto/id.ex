defmodule Uniris.Crypto.ID do
  ...
  """
  @spec id_from_curve(Uniris.Crypto.supported_curve()) :: integer()
  ...
  """
  @spec curve_from_id(integer()) :: Uniris.Crypto.supported_curve()
  ...
  """
  @spec id_from_hash(Uniris.Crypto.supported_hash()) :: integer()
  ...
  @spec identify_keypair({binary(), binary()}, integer()) ::
          {Uniris.Crypto.key(), Uniris.Crypto.key()}
