defmodule Uniris.Testnet do
  @moduledoc """
  Uniris Testnet Generator
  """
  ...
  @p2p_port Application.compile_env!(:uniris, Uniris.P2P.Endpoint)[:port]
  @web_port Application.compile_env!(:uniris, UnirisWeb.Endpoint)[:http][:port]
  ...
  ## Options
    ...
    * `:image` - image to use for uniris node
        ...
        version: "3.9",
          ...
          services: %{
            "node1" => %{
              ...
              environment: %{
                "UNIRIS_CRYPTO_SEED" => "seed1",
                "UNIRIS_MUT_DIR" => "/opt/data",
                "UNIRIS_P2P_SEEDS" => "1.2.3.2:#{@p2p_port}:009D421F8ACC11F7E25EC515732ECB7E3E38109118EC409701930D7A892E913428:tcp",
                "UNIRIS_STATIC_IP" => "1.2.3.2"},
              image: "i",
            ...
            "node2" => %{
              ...
              depends_on: ["node1"],
              environment: %{
                "UNIRIS_CRYPTO_SEED" => "seed2",
                "UNIRIS_MUT_DIR" => "/opt/data",
                "UNIRIS_P2P_SEEDS" => "1.2.3.2:#{@p2p_port}:009D421F8ACC11F7E25EC515732ECB7E3E38109118EC409701930D7A892E913428:tcp",
                "UNIRIS_STATIC_IP" => "1.2.3.3"},
              image: "i",
    ...
    {"node1",
     %{
       ...
       environment: %{
         ...
         "UNIRIS_P2P_SEEDS" => seeder(ip.(1 + 1), seed),
         "UNIRIS_STATIC_IP" => ip.(1 + 1)
       },
