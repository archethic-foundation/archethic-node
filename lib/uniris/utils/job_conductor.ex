defmodule Uniris.JobConductor do
  @moduledoc ~S"""
  ...
  ## Example
      ...
      iex> end
      iex>
      iex> {:ok, _} = Uniris.JobConductor.start_link [name: Uniris.JobConductor]
      iex>
      iex> spawn(fn -> Uniris.JobConductor.conduct f, [1] end)
      iex> spawn(fn -> Uniris.JobConductor.conduct f, [2] end)
      iex> Process.sleep(5) # let spawned calls some time to spawn
      iex>
      iex> Uniris.JobConductor.conduct f, [3]
      {:ok, :done}
      iex>
  ...
  ## Example
      ...
      iex> {:ok, c} = Uniris.JobConductor.start_link []
      iex>
      iex> Uniris.JobConductor.conduct(fn -> :done end, [], c)
      {:ok, :done}
      iex>
      iex> Uniris.JobConductor.conduct(fn -> raise "exception" end, [], c)
      {:rescued, %RuntimeError{message: "exception"}}
      iex>
      iex> Uniris.JobConductor.conduct(fn -> throw :garbage end, [], c)
      {:caught, :garbage}
  """
  ...
  @doc ~S"""
  Starts a `Uniris.JobConductor` process linked to the current process.
