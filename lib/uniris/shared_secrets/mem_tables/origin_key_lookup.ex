defmodule Uniris.SharedSecrets.MemTables.OriginKeyLookup do
  @moduledoc """
  ...
  @origin_key_table :uniris_origin_keys
  @origin_key_by_type_table :uniris_origin_key_by_type
  ...
  ## Examples
      ...
      iex> { :ets.info(:uniris_origin_keys)[:type], :ets.info(:uniris_origin_key_by_type)[:type] }
      { :set, :bag }
  """
  ...
  ## Examples
      ...
      iex> { :ets.tab2list(:uniris_origin_keys), :ets.tab2list(:uniris_origin_key_by_type) }
      {
          [
            {"key1", :software},
            {"key3", :hardware},
