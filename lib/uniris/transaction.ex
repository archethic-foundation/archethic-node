defmodule Uniris.Transaction do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Uniris.Transaction.serialize(%Uniris.Transaction{
      ...
      ...>   validation_stamp: %Uniris.Transaction.ValidationStamp{
