defmodule Uniris.TransactionData.Ledger do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Uniris.TransactionData.Ledger.serialize(%Uniris.TransactionData.Ledger{
      ...>   uco: %Uniris.TransactionData.UCOLedger{transfers: [
  ...
  ## Examples
      ...
      ...> 165, 11, 146, 194, 246, 89, 73, 85, 202, 120, 242, 136, 136, 63, 53,
      ...> 64, 37, 0, 0, 0, 0, 0, 0>>
      ...> |> Uniris.TransactionData.Ledger.deserialize()
      {
        %Uniris.TransactionData.Ledger{
