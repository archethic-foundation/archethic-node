defmodule Uniris.TransactionData.Keys do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> {pub, pv} = Uniris.Crypto.generate_deterministic_keypair("seed")
      iex> %{ authorized_keys: authorized_keys, secret: _} = Uniris.TransactionData.Keys.new([pub], secret_key, secret)
  ...
  ## Examples
      ...
      iex> Uniris.TransactionData.Keys.serialize(%Uniris.TransactionData.Keys{
  ...
  ## Examples
      ...
      ...> 212, 162, 48, 18, 15, 181, 70, 103, 32, 141, 4, 64, 107, 93, 117, 188, 244, 7,
      ...> 224, 214, 225, 146, 44, 83, 111, 34, 239, 99, 1, 126, 241, 246>>
      ...> |> Uniris.TransactionData.Keys.deserialize()
      {
        %Uniris.TransactionData.Keys{
          secret: <<205, 124, 251, 211, 28, 69, 249, 1, 58, 108, 16, 35, 23, 206, 198, 202>>,
          authorized_keys: %{
            <<0, 229, 188, 159, 80, 100, 5, 54, 152, 137, 201, 204, 24, 22, 125, 76, 29,
            83, 14, 154, 60, 66, 69, 121, 97, 40, 215, 226, 204, 133, 54, 187, 9>> =>
