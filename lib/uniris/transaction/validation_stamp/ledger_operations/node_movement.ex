defmodule Uniris.Transaction.ValidationStamp.LedgerOperations.NodeMovement do
  ...
  ## Examples
        ...
        iex> Uniris.Transaction.ValidationStamp.LedgerOperations.NodeMovement.serialize(
  ...
  ## Examples
    ...
    ...> 63, 211, 51, 51, 51, 51, 51, 51
    ...> >>
    ...> |> Uniris.Transaction.ValidationStamp.LedgerOperations.NodeMovement.deserialize()
    {
      %Uniris.Transaction.ValidationStamp.LedgerOperations.NodeMovement{
        to: <<0, 214, 107, 17, 107, 227, 11, 17, 43, 204, 48, 78, 129, 145, 126, 45, 68, 194,
          159, 19, 92, 240, 29, 37, 105, 183, 232, 56, 42, 163, 236, 251, 186>>,
