defmodule Uniris.TransactionChain do
  ...
  ## Examples
    ...
    With only one transaction
      ...
      <<0, 241, 213, 69, 31, 43, 186, 253, 122, 248, 64, 121, 74, 50, 205, 88, 194, 36, 36, 42, 60, 184, 209, 112, 180, 79, 90, 196, 138, 118, 245, 222, 175>>
    ...
    With multiple transactions
      ...
      ...>         proof_of_integrity: <<0, 241, 213, 69, 31, 43, 186, 253, 122, 248, 64, 121, 74, 50, 205, 88, 194, 36, 36, 42, 60, 184, 209, 112, 180, 79, 90, 196, 138, 118, 245, 222, 175>>
      ...>      }
      ...>    }
      ...> ]
      ...> |> TransactionChain.proof_of_integrity()
      # Hash of the transaction + previous proof of integrity
      <<0, 64, 147, 131, 167, 216, 44, 192, 31, 23, 198, 174, 44, 243, 222, 78, 218, 165, 170, 119, 2, 124, 131, 51, 38, 246, 143, 67, 230, 53, 250, 37, 136>>
  """
  ...
  ## Examples
      ...
      ...>        proof_of_integrity: <<0, 64, 147, 131, 167, 216, 44, 192, 31, 23, 198, 174, 44, 243, 222, 78, 218, 165, 170, 119, 2, 124, 131, 51, 38, 246, 143, 67, 230, 53, 250, 37, 136>>
      ...>      }
      ...>    },
      ...>    %Transaction{
      ...>      address:
