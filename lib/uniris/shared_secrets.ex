defmodule Uniris.SharedSecrets do
  ...
  """
  @spec origin_public_keys(origin_family()) :: list(Uniris.Crypto.key())
  ...
  @spec new_node_shared_secrets_transaction(
          authorized_node_public_keys :: list(Uniris.Crypto.key()),
          daily_nonce_seed :: binary(),
          aes_key :: binary()
        ) :: Uniris.Transaction.pending()
