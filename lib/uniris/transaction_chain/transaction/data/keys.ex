defmodule Uniris.TransactionChain.TransactionData.Keys do
  @moduledoc """
  ...
  ## Examples
      ...
      [
         <<0, 241, 101, 225, 229, 247, 194, 144, 229, 47, 46, 222, 243, 251, 171, 96,
  ...
  defp do_reduce_authorized_keys_bin(
         <<0::8, key::binary-32, encrypted_key::binary-size(80), rest::bitstring>>,
         acc
       ) do
  ...
  ## Examples
      ...
      ...>   }
      ...> }
      ...> |> Keys.authorized_key?(<<0, 229, 188, 159, 80, 100, 5, 54, 152, 137, 201, 204, 24, 22, 125, 76, 29,
      ...> 83, 14, 154, 60, 66, 69, 121, 97, 40, 215, 226, 204, 133, 54, 187, 9>>)
      true
  """
  ...
  ## Examples
      ...
      ...>   }
      ...> }
      ...> |> Keys.get_encrypted_key(<<0, 229, 188, 159, 80, 100, 5, 54, 152, 137, 201, 204, 24, 22, 125, 76, 29,
      ...> 83, 14, 154, 60, 66, 69, 121, 97, 40, 215, 226, 204, 133, 54, 187, 9>>)
      <<139, 100, 20, 32, 187, 77, 56, 30, 116, 207, 34, 95, 157, 128, 208, 115, 113,
        177, 45, 9, 93, 107, 90, 254, 173, 71, 60, 181, 113, 247, 75, 151, 127, 41, 7,
        233, 227, 98, 209, 211, 97, 117, 68, 101, 59, 121, 214, 105, 225, 218, 91, 92,
