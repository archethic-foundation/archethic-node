defmodule Archethic.Mining.ValidationContext do
  ...
  def get_cross_validation_state(%__MODULE__{
      ...
      do: ProofOfValidation.get_state(stamps, validation_time)
  ...
  def create_proof_of_validation(
        context = %__MODULE__{cross_validation_stamps: stamps, validation_time: validation_time}
      ) do
    %__MODULE__{context | proof_of_validation: ProofOfValidation.create(stamps, validation_time)}
  end
  ...
  def valid_proof_of_validation?(
    ...
    validation_nodes = ProofOfValidation.get_nodes(proof, validation_time)
