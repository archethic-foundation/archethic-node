defmodule ArchEthic.Metrics.Parser do
  ...
  ## Examples
          ...
          [%{metrics: [%{:labels => %{"nb_nodes" => "\\"1\\""}, :quantiles => %{"\\"+Inf\\"" => "1336", "\\"0.001\\"" => "1329"}, "count" => "1336", "sum" => "0.073"}, %{:labels => %{"nb_nodes" => "\\"2\\""}, :quantiles => %{"\\"+Inf\\"" => "128", "\\"0.001\\"" => "121"}, "count" => "128", "sum" => "0.02"}, %{:labels => %{"nb_nodes" => "\\"3\\""}, :quantiles => %{"\\"+Inf\\"" => "22437", "\\"0.001\\"" => "21997"}, "count" => "22437", "sum" => "5.7"}], name: "archethic_election_storage_nodes_duration", type: "histogram"}, %{metrics: [%{value: "1589609"}], name: "vm_memory_atom", type: "gauge"}, %{metrics: [%{:quantiles => %{"'+Inf'" => "177", "'0.001'" => "153"}, "count" => "177", "sum" => "0.12"}], name: "archethic_contract_parsing_duration", type: "histogram"}]
