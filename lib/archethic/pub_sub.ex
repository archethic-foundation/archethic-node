defmodule ArchEthic.PubSub do
  ...
  """
  def notify_next_epoch_of_slot_timer(date = %DateTime{}) do
    dispatch(:next_epoch_of_slot_timer, {:next_epoch_of_slot_timer, date})
  end
  ...
  @doc """
  Register a process to sent next epoch of slot time
  """
