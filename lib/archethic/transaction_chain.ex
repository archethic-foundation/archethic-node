defmodule ArchEthic.TransactionChain do
  ...
  ## Examples
    ...
    With only one transaction
      ...
      <<0, 0, 129, 254, 255, 206, 75, 42, 96, 95, 51, 71, 50, 198, 115, 23, 145, 238, 155, 179, 33, 213, 110, 160, 140, 187, 135, 255, 156, 43, 52, 189, 254, 78>>
    ...
    #   ...>         proof_of_integrity: <<0, 129, 254, 255, 206, 75, 42, 96, 95, 51, 71, 50, 198, 115, 23, 145, 238,
    #   ...>           155, 179, 33, 213, 110, 160, 140, 187, 135, 255, 156, 43, 52, 189, 254, 78>>
    #   ...>      }
    #   ...>    }
    #   ...> ]
    #   ...> |> TransactionChain.proof_of_integrity()
    #   # Hash of the transaction + previous proof of integrity
    #   <<0, 0, 191, 70, 89, 151, 55, 18, 143, 44, 255, 246, 97, 86, 1, 102, 246, 48, 210,
  ...
  ## Examples
      ...
      # ...>        proof_of_integrity: <<0, 0, 191, 70, 89, 151, 55, 18, 143, 44, 255, 246, 97, 86, 1, 102, 246, 48, 210,
      # ...>          26, 207, 228, 116, 102, 47, 32, 16, 225, 45, 26, 53, 154, 123, 106>>
      # ...>      }
      # ...>    },
      # ...>    %Transaction{
      ...
      # ...>        proof_of_integrity: <<0, 0, 129, 254, 255, 206, 75, 42, 96, 95, 51, 71, 50, 198, 115, 23, 145, 238,
      # ...>           155, 179, 33, 213, 110, 160, 140, 187, 135, 255, 156, 43, 52, 189, 254, 78>>
      # ...>      }
      # ...>    }
      # ...> ]
