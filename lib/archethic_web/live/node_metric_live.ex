defmodule ArchEthicWeb.NodeMetricsLive do
  @moduledoc """
      Live-View for this-Node-Metric-Dashboard
  """
          ...
          <div class="columns">
              ...
              <div class="tile is-ancestor">
                          <div class="tile is-7 is-parent">
                                <article class="tile is-child box">
                                  <div id='archethic_p2p_send_message_duration'
                                    phx-hook='node_charts' style="width: 100%; height: 448px" > <canvas id="echartDiv"  phx-update='ignore' style="width: 100%; min-height: 448px">  </canvas></div>
                                    </article>
                          </div>
                          ...
                          <div class="tile is-5 is-vertical">
                                  ...
                                  <div class= "tile is-parent">
                                      ...
                                      <div id='archethic_mining_pending_transaction_validation_duration' class="box" phx-hook='node_charts' style="width: 100%; height: 250px" >
            ...
            <div class="tile  is-ancestor">
                  <div class="tile is-6 is-parent">
                      <article class="tile is-child">
                      <div id='archethic_mining_fetch_context_duration' class="box" phx-hook='node_charts' style="width: 100%; height: 270px" >
  ...
  def handle_info(:update, socket) do
    new_points = ArchEthic.Metrics.MetricClient.subscribe_to_node_updates()
